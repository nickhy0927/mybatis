    ...
    <article class="page-container">
        <form class="form form-horizontal" id="addForm">
			...
			<div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="alias" id="alias" class="input-text" value="" placeholder="please enter alias">
                </div>
            </div>
			<div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">
			...
			<div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="shows" id="shows" class="input-text" value="" placeholder="please enter shows">
                </div>
            </div>
			<div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">
