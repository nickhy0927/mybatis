...
<@htmlHead>
    <script type="text/javascript">
        function create() {
            $.openWindow('创建模板', '80%', '80%', "${basePath}/platform/menu/menu-create.do");
        }
        
        function edit(id) {
            $.openWindow('修改模板', '80%', '80%', "${basePath}/platform/menu/menu-edit/"+ id +".do");
        }
		...
		function initData() {
			$("#dataGridList").dataGrid({
                ...
                columns: [
					...
					{field: 'code', className: 'text-l', description: '菜单编号 ', sort: true, paramFormatter: function (row) {}},
					{field: 'name', className: 'text-l', description: '菜单名称 ', sort: true, paramFormatter: function (row) {}},
					{field: 'url', className: 'text-l', description: '菜单地址 ', sort: true, paramFormatter: function (row) {}},
					{field: 'alias', className: 'text-l', description: '菜单别名 ', sort: true, paramFormatter: function (row) {}},
					{field: 'menuId', className: 'text-l', description: '上级菜单 ', sort: true, paramFormatter: function (row) {}},
					{field: 'enable', className: 'text-l', description: '是否启用 1 启用 0 停用 ', sort: true, paramFormatter: function (row) {}},
					{field: 'shows', className: 'text-l', description: '是否显示 1 显示 0 隐藏 ', sort: true, paramFormatter: function (row) {}},
