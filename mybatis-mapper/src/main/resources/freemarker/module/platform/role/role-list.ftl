...
<@htmlHead>
    <script type="text/javascript">
        function create() {
            $.openWindow('创建模板', '80%', '80%', "${basePath}/platform/role/role-create.do");
        }
        
        function edit(id) {
            $.openWindow('修改模板', '80%', '80%', "${basePath}/platform/role/role-edit/"+ id +".do");
        }
        
        function delete(id, single) {
            $.datadel({
            	url: "${basePath}/platform/role/role-edit/"+ id +".do",
                type: "post",
                data: {id: id},
		...
		function initData() {
			$("#dataGridList").dataGrid({
                ...
                columns: [
					...
					{field: 'code', className: 'text-l', description: '角色编号 ', sort: true, paramFormatter: function (row) {}},
					{field: 'name', className: 'text-l', description: '角色名称 ', sort: true, paramFormatter: function (row) {}},
					{field: 'roleId', className: 'text-l', description: '上级角色 ', sort: true, paramFormatter: function (row) {}},
					{field: 'remark', className: 'text-l', description: '信息备注 ', sort: true, paramFormatter: function (row) {}},
					{field: 'frozen', className: 'text-l', description: '是否冻结 1 冻结 0 未冻结', sort: true, paramFormatter: function (row) {}},
...
<@htmlBody>
	<nav class="breadcrumb">
        ...
        <span class="c-gray en">&gt;</span> Role管理
        <span class="c-gray en">&gt;</span> Role列表
