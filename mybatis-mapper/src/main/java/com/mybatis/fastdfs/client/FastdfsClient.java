...
public class FastdfsClient {
    ...
    public void setFastdfsEnvironment(FastdfsEnvironment fastdfsEnvironment) {
        this.fastdfsEnvironment = fastdfsEnvironment;
    }
    ...
    public String upload(InputStream is, String filename, Map<String, String> descriptions) throws FastDFSException {
        ...
        try {
            if(is.available() > fastdfsEnvironment.getMaxFileSize()){
     ...
     * @return 文件描述信息
     */
    private Map<String, Object> getFileDescriptions(String filepath) throws FastDFSException {
        TrackerServer trackerServer = TrackerServerPool.borrowObject();
        StorageClient1 storageClient = new StorageClient1(trackerServer, null);
        NameValuePair[] nvps = null;
        try {
