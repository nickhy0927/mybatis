        ...
        <form class="form form-horizontal" id="addForm">
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="realName" id="realName" class="input-text" value="${user.realName}"
                           placeholder="请输入真实姓名">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" disabled="disabled" readonly="readonly" name="loginName" id="loginName"
                           class="input-text" value="${user.loginName}" placeholder="请输入登录账户">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">
                ...
                <div class="formControls col-xs-3 col-sm-3 skin-minimal">
                    <div class="radio-box">
                        <input name="locked" value="1" [#if user.locked == 1]checked="checked"[/#if] type="radio"
                               id="locked-1" checked>
                        <label for="locked-1">锁定</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" value="0" [#if user.locked == 0]checked="checked"[/#if] id="locked-2"
                               name="locked">
                ...
                <div class="formControls col-xs-3 col-sm-4 skin-minimal">
                    <div class="radio-box">
                        <input name="enable" value="1" [#if user.enable == 1]checked="checked"[/#if] type="radio"
                               id="enable-1" checked>
                        <label for="enable-1">启用</label>
                    </div>
                    <div class="radio-box">
                        <input type="radio" value="0" [#if user.enable == 0]checked="checked"[/#if] id="enable-2"
                               name="enable">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="mobile" id="mobile" class="input-text" value="${user.mobile}"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="position" id="position" class="input-text" value="${user.position}"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="remark" id="remark" class="input-text" value="${user.remark}"
