...
public class RestExceptionHandler {
    ...
    public String nullPointerExceptionHandler(NullPointerException ex) {
        ex.printStackTrace();
        return ReturnFormat.retParam(1001, ex.getMessage());
    }
    ...
    public String classCastExceptionHandler(ClassCastException ex) {
        ex.printStackTrace();
        return ReturnFormat.retParam(1002, ex.getMessage());
    }
    ...
    public String iOExceptionHandler(IOException ex) {
        ex.printStackTrace();
        return ReturnFormat.retParam(1003, ex.getMessage());
    }
    ...
    public String noSuchMethodExceptionHandler(NoSuchMethodException ex) {
        ex.printStackTrace();
        return ReturnFormat.retParam(1004, ex.getMessage());
    }
    ...
    public String server500(RuntimeException runtimeException) {
        ...
        return ReturnFormat.retParam(406, runtimeException.getMessage());
    }
}
