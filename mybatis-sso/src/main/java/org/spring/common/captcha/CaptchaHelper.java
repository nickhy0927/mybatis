package org.spring.common.captcha;
...
public class CaptchaHelper {
	...
	public static boolean validate(HttpServletRequest request, String captcha) {
		Object object = request.getSession().getAttribute("randCode");
		return object == null ? false : object.toString().equalsIgnoreCase(captcha);
	}
}