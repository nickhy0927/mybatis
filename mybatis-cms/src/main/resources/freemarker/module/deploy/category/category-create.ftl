        ...
        $(document).ready(function () {
            ...
            $.validation('addForm', {
                ...
                $.openTip('你确定要保存栏目吗？',false ,function() {
                    ...
                    $.ajax({
                        url: '${basePath}/deploy/category/category-save.json',
                        method: 'POST',
                        dataType: 'JSON',
        ...
        $(document).ready(function () {
            ...
            if (categoryList) {
                $.each(categoryList,function (index, obj) {
                    $('select[name="type"]').append("<option value='" + obj['value'] +"'>" + obj['text'] + "</option>")
                })
            }
        });
    </script>
        ...
        <form class="form form-horizontal" id="addForm">
            <div class="row cl">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" readonly="readonly" name="code" id="code" class="input-text" value="${code}" placeholder="请输入栏目编号">
                </div>
            </div>
			<div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" name="name" id="name" class="input-text" value="" placeholder="请输入栏目名称">
                </div>
            </div>
			<div class="row cl">
                <label class="form-label col-xs-3 col-sm-2">
                ...
                <div class="formControls col-xs-9 col-sm-9">
                    <input type="text" onfocus="showTree()" onclick="showTree()"
                           name="categoryName" id="categoryName" class="input-text"
                           placeholder="请选择上级栏目">
