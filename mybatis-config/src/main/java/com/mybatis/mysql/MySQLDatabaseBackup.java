...
public class MySQLDatabaseBackup {  
     ...
     */  
    public static boolean exportDatabaseTool(Database database, String savePath) throws InterruptedException {  
        ...
        try {  
			...
			String mysqldump = database.getMysqldumpPath() + "\\mysqldump";
