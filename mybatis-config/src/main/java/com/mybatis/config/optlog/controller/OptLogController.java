...
public class OptLogController {
	 ...
	 * 新增页面
	 */
	@RequestMapping(value = "/config/optlog/opt-log-create.do", method = RequestMethod.GET)
	 ...
	 */
	@ResponseBody
    @RequestMapping(value = "/config/optlog/opt-log-save.json", method = RequestMethod.POST)
	 ...
	 * 修改页面
	 */
	@RequestMapping(value = "/config/optlog/opt-log-edit/{id}.do", method = RequestMethod.GET)
	public String optLogEdit(@PathVariable(value = "id") String id, Model model) {
		OptLog optLog = optLogService.get(id);
		model.addAttribute("optLog", optLog);
		return "module/config/optlog/opt-log-edit";
	}
	 ...
	 */
	@ResponseBody
    @RequestMapping(value = "/config/optlog/opt-log-update.json", method = RequestMethod.POST)
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/config/optlog/opt-log-delete/{id}.json", method = RequestMethod.POST)
	 ...
	 * 列表页面
	 */
	@RequestMapping(value = "/config/optlog/opt-log-list.do", method = RequestMethod.GET)
	public String optLogList() {
		return "module/config/optlog/opt-log-list";
	}
	 ...
	 */
    @ResponseBody
	@RequestMapping(value = "/config/optlog/opt-log-list.json", method = RequestMethod.POST)
